...
const ListCard = ({ token, price, amount, duration, id }: ListCardProps) => {
  const handleTrade = (walletId: number) => {
  ...
  return (
    ...
    >
      <Image src={logofull} alt="Caffe Latte" width={200} height={200} />
      ...
      <Stack>
        ...
        <CardFooter>
          <button
            className="bg-green-main text-white font-bold rounded-md w-20 h-10"
